---
title: "Overview"
description: Community-driven guide for setting up nodes in the 0G Labs ecosystem | BANGCODE
---
...
👉 [Go to Validator Section](./0g-labs/validator-node)
...
👉 [Go to Storage Node Guide](./storage-node/installation)
